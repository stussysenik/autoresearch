...
IS_CUDA = DEFAULT_DEVICE.type == "cuda"

MAX_SEQ_LEN = env_int("AUTORESEARCH_MAX_SEQ_LEN", 2048 if IS_CUDA else 512)
TIME_BUDGET = env_int("AUTORESEARCH_TIME_BUDGET", 300)
EVAL_TOKENS = env_int("AUTORESEARCH_EVAL_TOKENS", 40 * 524288 if IS_CUDA else 524288)
...
VOCAB_SIZE = 8192
DEFAULT_NUM_SHARDS = env_int("AUTORESEARCH_NUM_SHARDS", 10 if IS_CUDA else 2)
