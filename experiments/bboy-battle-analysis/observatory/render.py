...
from observatory.body_state import BodyState, TemporalWindow, compute_body_states
from observatory.color_system import BG_COLOR, PANEL_BG, TRAIL_LENGTH
from observatory.header import HEADER_HEIGHT, render_header
from observatory.skeleton_panel import render_skeleton_panel
from observatory.timeline_strip import render_timeline_strip
from observatory.video_panel import render_video_panel
...
def render_observatory(
    ...
    from observatory.body_state import compute_beat_alignment, compute_velocities
    beat_hits = None
    if beats is not None:
