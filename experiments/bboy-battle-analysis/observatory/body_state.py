...
# Import constants from analyze_motion.py (same directory)
...
from observatory.color_system import (  # noqa: E402
...
def compute_body_states(
    ...
    for t in range(T):
        ...
        for j in range(24):
            ...
            is_contact = (pos[2] < CONTACT_Z_THRESHOLD and spd < CONTACT_SPEED_THRESHOLD)
